...
The edit includes the starting mix, actual processing and listening, David's fader intervention, playback inside Codex, the same passage before/after at matched listening level, and his basic-pass caveat. The Short is composed from raw camera and screen sources. David rejected the initial thumbnail face as sleepy; both final covers use the alert camera frame at 1019.8 seconds.
