...
> current: astra-full-jam REV2 is DELIVERED 2026-09-11 (same cuts, full-frame camera, Wretcher stigmergy bed, DPD cards, Short relaid out). Next action is David's end-to-end watch and listen, then upload only if authorized.
