...
**Thumbnails need revision:** David rejected the initial sleepy face and the subsequent generated portraits based on camera 1019.8s. Those rejected covers still occupy the final thumbnail filenames. At his request, a broader source scan found a clear smile around camera 12:20. Full-resolution unaltered source frames at 740.0s and 740.4s, plus `smiling-frame-options.jpg`, are in `C:/media/video/astra-reaper-mix/working/thumbnail-candidates/`. Candidate A (740.0s) faces the camera; B (740.4s) looks toward the monitor. Neither has been selected by David or applied to the covers yet. Inspection evidence and export scripts are under `projects/astra-reaper-mix/thumbs/face-candidates/`. Both videos and the social copy are unchanged.
